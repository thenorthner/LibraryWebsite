...
class EceSemester7Screen extends StatefulWidget {
  const EceSemester7Screen({Key? key}) : super(key: key);

  @override
  State<EceSemester7Screen> createState() => _EceSemester5ScreenState();
}

class _EceSemester5ScreenState extends State<EceSemester7Screen> {
