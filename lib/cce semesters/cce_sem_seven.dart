...
class CceSemester7Screen extends StatefulWidget {
  const CceSemester7Screen({Key? key}) : super(key: key);

  @override
  State<CceSemester7Screen> createState() => _CceSemester7ScreenState();
}

class _CceSemester7ScreenState extends State<CceSemester7Screen> {
