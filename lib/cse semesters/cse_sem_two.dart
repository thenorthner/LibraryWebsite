...
class CseSemester2Screen extends StatefulWidget {
  const CseSemester2Screen({Key? key}) : super(key: key);

  @override
  State<CseSemester2Screen> createState() => _CseSemester6ScreenState();
}

class _CseSemester6ScreenState extends State<CseSemester2Screen> {
