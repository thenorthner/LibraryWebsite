...
class CseSemester6Screen extends StatefulWidget {
  const CseSemester6Screen({Key? key}) : super(key: key);

  @override
  State<CseSemester6Screen> createState() => _CseSemester6ScreenState();
}

class _CseSemester6ScreenState extends State<CseSemester6Screen> {
