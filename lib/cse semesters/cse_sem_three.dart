...
class CseSemester3Screen extends StatefulWidget {
  const CseSemester3Screen({Key? key}) : super(key: key);

  @override
  State<CseSemester3Screen> createState() => _CseSemester6ScreenState();
}

class _CseSemester6ScreenState extends State<CseSemester3Screen> {
